...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('training_courses', function (Blueprint $table) {
            ...
            $table->index('school_id', 'idx_training_school');
            $table->index('branch_id', 'idx_training_branch');
            $table->index('course_type_id', 'idx_training_type');
            $table->index('tag_id', 'idx_training_tag');
        });
    }
