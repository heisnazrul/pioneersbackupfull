...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('online_courses', function (Blueprint $table) {
            ...
            $table->index('school_id', 'idx_online_courses_school');
            $table->index('course_type_id', 'idx_online_courses_type');
            $table->index('tag_id', 'idx_online_courses_tag');
            $table->index('status', 'idx_online_courses_status');
        });
    }
