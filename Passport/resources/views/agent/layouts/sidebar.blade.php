    <aside class="app-sidebar" id="sidebar">
        ...
        <div class="main-sidebar-header">
            <a href="{{ route('agent.dashboard') }}" class="header-logo">
        ...
        <div class="main-sidebar" id="sidebar-scroll">
            ...
            <nav class="main-menu-container nav nav-pills flex-column sub-open">
                ...
                <ul class="main-menu">
                    ...
                    <li class="slide">
                        <a href="{{ route('agent.dashboard') }}" class="side-menu__item">
                            <i class="ri-home-8-line side-menu__icon"></i>
                            <span class="side-menu__label">Dashboard</span>
                        </a>
                    </li>
                    <li class="slide">
                        <a href="{{ route('agent.referrals.index') }}" class="side-menu__item">
                            <i class="ri-links-line side-menu__icon"></i>
                            <span class="side-menu__label">Referrals</span>
                        </a>
                    </li>
                    <li class="slide">
                        <a href="{{ route('agent.students.index') }}" class="side-menu__item">
