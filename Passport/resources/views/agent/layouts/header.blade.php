      ...
      <nav class="main-header" aria-label="Global">
        <div class="header-content">
          ...
          <div class="responsive-logo">
            <a class="responsive-logo-dark" href="{{ route('agent.dashboard') }}" aria-label="Brand"><img
                src="{{ asset('assets/img/brand-logos/desktop-logo.png') }}" alt="logo" class="mx-auto"></a>
            <a class="responsive-logo-light" href="{{ route('agent.dashboard') }}" aria-label="Brand"><img
            ...
            <div class="responsive-headernav">
              <div class="header-nav-right">
                @php
                  ...
                  $displayName = $authUser?->name ?: ($authUser?->email ?: 'Agent');
