...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    ...
    <a href="{{ route('admin.branch-registration-fees.create') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">Add Fee</a>
  </div>
  ...
  <div class="bg-white rounded-lg shadow-md p-4 mb-6">
    <form method="GET" action="{{ route('admin.branch-registration-fees.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
      ...
      <div class="md:col-span-4 flex items-end gap-2">
        ...
        <a href="{{ route('admin.branch-registration-fees.index') }}" class="ti-btn rounded-full border">Reset</a>
      </div>
    </form>
  </div>
    ...
    <table class="min-w-full bg-white">
      ...
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="px-6 py-4 text-sm">
            <a href="{{ route('admin.branch-registration-fees.edit', $fee) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
            <form action="{{ route('admin.branch-registration-fees.destroy', $fee) }}" method="POST" class="inline-block" onsubmit="return confirm('Delete this fee?');">
              @csrf
              @method('DELETE')
