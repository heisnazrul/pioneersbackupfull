...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    ...
    <a href="{{ route('admin.accommodations.create') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">
      Add Accommodation
    </a>
  </div>
  ...
  <div class="bg-white rounded-lg shadow-md p-4 mb-6">
    <form method="GET" action="{{ route('admin.accommodations.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
      ...
      <div class="md:col-span-4 flex items-end gap-2">
        ...
        <a href="{{ route('admin.accommodations.index') }}" class="ti-btn rounded-full border">Reset</a>
      </div>
    </form>
  </div>
    ...
    <table class="min-w-full bg-white">
      ...
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="px-6 py-4 text-sm">
            <a href="{{ route('admin.accommodations.edit', $acc) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
            <form action="{{ route('admin.accommodations.destroy', $acc) }}" method="POST" class="inline-block" onsubmit="return confirm('Delete this accommodation?');">
              @csrf
              @method('DELETE')
