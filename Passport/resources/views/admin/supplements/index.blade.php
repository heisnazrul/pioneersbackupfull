...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    ...
    <a href="{{ route('admin.supplements.create') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">
      Add Supplement
    </a>
  </div>
      ...
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="px-6 py-4 text-sm">
            <a href="{{ route('admin.supplements.edit', $s) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
            <form action="{{ route('admin.supplements.destroy', $s) }}" method="POST" class="inline-block" onsubmit="return confirm('Delete this supplement?');">
              @csrf
              @method('DELETE')
