...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    ...
    <a href="{{ route('admin.branch-high-season-fees.index') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">Back to List</a>
  </div>
  ...
  <form action="{{ route('admin.branch-high-season-fees.update', $fee) }}" method="POST" class="space-y-4">
    @csrf
    @method('PUT')
    ...
    <div class="flex space-x-2">
      ...
      <a href="{{ route('admin.branch-high-season-fees.index') }}" class="ti-btn rounded-full border">Cancel</a>
    </div>
  </form>
</div>
@endsection
