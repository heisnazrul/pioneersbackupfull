...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    ...
    <a href="{{ route('admin.branch-high-season-fees.create') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">Add High Season Fee</a>
  </div>
    ...
    <table class="min-w-full bg-white">
      ...
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="px-6 py-4 text-sm">
            <a href="{{ route('admin.branch-high-season-fees.edit', $fee) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
            <form action="{{ route('admin.branch-high-season-fees.destroy', $fee) }}" method="POST" class="inline-block" onsubmit="return confirm('Delete this fee?');">
              @csrf
              @method('DELETE')
