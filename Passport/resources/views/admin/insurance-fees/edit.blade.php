...
<div class="main-content py-10">
    <div class="flex justify-between py-10">
        ...
        <a href="{{ route('admin.insurance-fees.index') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">Back to List</a>
    </div>
    ...
    <form action="{{ route('admin.insurance-fees.update', $insuranceFee) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="flex space-x-2 mt-4">
            ...
            <a href="{{ route('admin.insurance-fees.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-100">Cancel</a>
        </div>
    </form>
</div>
@endsection
