...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    <h2 class="text-2xl font-bold mb-4">Create Online Course</h2>
  ...
  <form action="{{ route('admin.online-courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <input type="number" name="lessons_per_week" value="{{ old('lessons_per_week') }}" min="0" class="mt-1 block w-full border rounded-md px-3 py-2">
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700">Minimum Age</label>
        <input type="number" name="min_age" value="{{ old('min_age') }}" min="0" class="mt-1 block w-full border rounded-md px-3 py-2">
      </div>
      <div>
      ...
      <div>
        ...
        <input type="text" name="currency_code" value="{{ old('currency_code','USD') }}" maxlength="3" class="mt-1 block w-full border rounded-md px-3 py-2" required>
      </div>
      <div>
      ...
      <div>
        ...
        <p class="text-xs text-gray-500 mt-1">Upload up to 2MB. Landscape images look best.</p>
      </div>
    ...
    <div class="flex space-x-2">
      <button type="submit" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-success">Save Online Course</button>
