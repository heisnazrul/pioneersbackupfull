...
@section('content')
    <div class="main-content py-10">
        <div class="flex justify-between py-10">
            <h2 class="text-2xl font-bold mb-4">Edit Video Review</h2>
        ...
        <form action="{{ route('admin.video-reviews.update', $videoReview->id) }}" method="POST"
            enctype="multipart/form-data" class="space-y-4 bg-white p-6 rounded-lg shadow-md">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $videoReview->name) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="course_name" id="course_name"
                        value="{{ old('course_name', $videoReview->course_name) }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="university_name" id="university_name"
                        value="{{ old('university_name', $videoReview->university_name) }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="country_name" id="country_name"
                        value="{{ old('country_name', $videoReview->country_name) }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="video_url" id="video_url"
                        value="{{ old('video_url', $videoReview->video_url) }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($videoReview->thumbnail)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $videoReview->thumbnail) }}" alt="Current Thumbnail"
                                class="h-20 rounded">
                        </div>
                    @endif
            ...
            <div class="form-group">
                ...
                <textarea name="review_text" id="review_text" rows="4"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('review_text', $videoReview->review_text) }}</textarea>
            </div>
            ...
            <div class="form-group">
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $videoReview->is_active) ? 'checked' : '' }}
