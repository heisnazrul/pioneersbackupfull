...
use App\Http\Controllers\{
    ...
    SummerCampController,
    CourseFeeController,
    SummerController,
    HighSeasonFeeController,
    RegistrationFeeController,
    MaterialFeeController,
    PickupController,
    InsuranceFeeController,
    ...
    MealController,
    DiscountController,
    ReferralDiscountController,
    PioneersDiscountController,
    CouponController,
    WishListController,
    ReviewController,
    BlogController,
    ...
    SchoolBranchController,
    LanguageCourseController,
    LanguageCourseFeeController,
    LanguageCourseMaterialFeeController,
    BranchRegistrationFeeController,
    BranchHighSeasonFeeController,
    TrainingCourseController,
    SummerCampDetailController,
    GalleryController,
    MaintenanceController,
    PreferredSchoolController,
    CourseTypeController
};

use App\Http\Controllers\Admin\AgentReferralController;
use App\Http\Controllers\Admin\UniversityController;
use App\Http\Controllers\Admin\UniversityCampusController;
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    // Bedroom Types (Keep those, verified?) No, BedroomTypeController exists.
...
// Gallery
    ...
    // Video Reviews
    Route::resource('/admin/video-reviews', \App\Http\Controllers\Admin\VideoReviewController::class)->names('admin.video-reviews');
    ...
    // Blog Tags
    Route::get('/admin/blog-tags', [App\Http\Controllers\Admin\BlogTagController::class, 'index'])->name('admin.blog-tags.index');
    Route::get('/admin/blog-tags/create', [App\Http\Controllers\Admin\BlogTagController::class, 'create'])->name('admin.blog-tags.create');
    Route::post('/admin/blog-tags', [App\Http\Controllers\Admin\BlogTagController::class, 'store'])->name('admin.blog-tags.store');
    Route::get('/admin/blog-tags/{blogTag}/edit', [App\Http\Controllers\Admin\BlogTagController::class, 'edit'])->name('admin.blog-tags.edit');
    Route::put('/admin/blog-tags/{blogTag}', [App\Http\Controllers\Admin\BlogTagController::class, 'update'])->name('admin.blog-tags.update');
    Route::delete('/admin/blog-tags/{blogTag}', [App\Http\Controllers\Admin\BlogTagController::class, 'destroy'])->name('admin.blog-tags.destroy');
    ...
    Route::resource('/admin/destinations', \App\Http\Controllers\Admin\DestinationController::class)->names('admin.destinations');

    Route::get('/admin/campuses', [UniversityCampusController::class, 'index'])->name('admin.campuses.index');
    Route::get('/admin/campuses/create', [UniversityCampusController::class, 'create'])->name('admin.campuses.create');
    Route::post('/admin/campuses', [UniversityCampusController::class, 'store'])->name('admin.campuses.store');
    Route::get('/admin/campuses/{university_campus}', [UniversityCampusController::class, 'show'])->name('admin.campuses.show');
    Route::get('/admin/campuses/{university_campus}/edit', [UniversityCampusController::class, 'edit'])->name('admin.campuses.edit');
    Route::put('/admin/campuses/{university_campus}', [UniversityCampusController::class, 'update'])->name('admin.campuses.update');
    Route::delete('/admin/campuses/{university_campus}', [UniversityCampusController::class, 'destroy'])->name('admin.campuses.destroy');
    Route::patch('/admin/campuses/{university_campus}/restore', [UniversityCampusController::class, 'restore'])->name('admin.campuses.restore');

    Route::get('/admin/university-courses', [UniversityCourseController::class, 'index'])->name('admin.university-courses.index');
    Route::get('/admin/university-courses/create', [UniversityCourseController::class, 'create'])->name('admin.university-courses.create');
    Route::post('/admin/university-courses', [UniversityCourseController::class, 'store'])->name('admin.university-courses.store');
    Route::get('/admin/university-courses/{university_course}', [UniversityCourseController::class, 'show'])->name('admin.university-courses.show');
    Route::get('/admin/university-courses/{university_course}/edit', [UniversityCourseController::class, 'edit'])->name('admin.university-courses.edit');
    Route::put('/admin/university-courses/{university_course}', [UniversityCourseController::class, 'update'])->name('admin.university-courses.update');
    Route::delete('/admin/university-courses/{university_course}', [UniversityCourseController::class, 'destroy'])->name('admin.university-courses.destroy');
    Route::patch('/admin/university-courses/{university_course}/restore', [UniversityCourseController::class, 'restore'])->name('admin.university-courses.restore');
    ...
    Route::prefix('cms')->name('admin.cms.')->group(function () {
        Route::get('/university/home', [CmsController::class, 'universityHome'])->name('university.home');
        Route::post('/university/home/{section}', [CmsController::class, 'updateUniversityHome'])->name('university.home.update');
        Route::get('/course-english', [CmsController::class, 'courseEnglishIndex'])->name('course-english.index');
    });

    // Applications
    Route::resource('/admin/applications', \App\Http\Controllers\Admin\ApplicationController::class)->names('admin.applications');
