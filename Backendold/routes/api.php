...
Route::get('/destination-guides', [\App\Http\Controllers\Api\DestinationGuideController::class, 'index']);
...
Route::get('/settings/public', function () {
    return response()->json([
        'contact' => \App\Support\SystemSettings::contactInfo(),
...
Route::get('/accommodation-rooms', [\App\Http\Controllers\Api\AccommodationRoomController::class, 'index']);
Route::get('/accommodation-rooms/{slug}', [\App\Http\Controllers\Api\AccommodationRoomController::class, 'show']);
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('/my-uni-applications', [\App\Http\Controllers\Api\UniApplicationController::class, 'myApplications']); // New User's Uni Apps
    ...
    // Wishlist
    Route::get('/wishlist', [\App\Http\Controllers\Api\UniversityWishlistController::class, 'index']);
    Route::post('/wishlist', [\App\Http\Controllers\Api\UniversityWishlistController::class, 'store']);
    Route::delete('/wishlist/{course}', [\App\Http\Controllers\Api\UniversityWishlistController::class, 'destroy']);
